...
type MarkerKind = 'restaurant' | 'customer' | 'rider';

const MARKER_META: Record<
  MarkerKind,
  { icon: keyof typeof Ionicons.glyphMap; color: string; bg: string; label: string }
> = {
  restaurant: { icon: 'restaurant', color: '#ffffff', bg: '#ff5a00', label: 'Restaurant' },
  customer: { icon: 'home', color: '#ffffff', bg: '#1a1c1c', label: 'Delivery' },
  rider: { icon: 'navigate', color: '#ffffff', bg: '#00BCD4', label: 'Rider' },
};
